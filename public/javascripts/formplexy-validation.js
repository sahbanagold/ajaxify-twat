	...
	$(".forgotten-password-trigger").click(function() {
  	...
  	$("#login-form").submit(function() {
	    ...
	    */
	    ...
	    if (value_login != "" && value_password != "" && value_secret != "")
	    {
	    	...
	    	$("#status-password").switchClass("icon-close", "icon-check");
				...
				$("#secret").addClass("icon-check");
	    	$("#secret").switchClass("icon-close", "icon-check");
	      	...
	      	else if (value_password != "")
	      	{
	 			...
	 			$(".login-password").removeClass("error-placeholder");
	      		$("#login-password").removeClass("error-input");
					...
					if (value_secret == "")
	      	{
	      		$("#status-secret").removeClass("icon-check");
	      		$("#status-secret").addClass("icon-close");
	      		$(".login-secret").addClass("error-placeholder");
	      		$("#login-secret").addClass("error-input");
	      	}

	      	// If password is ok but login not
	      	else if (value_password != "")
	      	{
	  			$("#status-secret").removeClass("icon-close");
	 			$("#status-secret").addClass("icon-check");
	 			$(".login-secret").removeClass("error-placeholder");
	      		$("#login-secret").removeClass("error-input");	
	      	}
